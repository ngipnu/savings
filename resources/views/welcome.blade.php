...
<body class="bg-gradient-to-br from-slate-50 to-emerald-50 min-h-screen relative overflow-x-hidden text-slate-800">

    <!-- Decorative Shapes -->
    <div class="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-200 rounded-full blur-3xl opacity-20 -translate-y-1/2 translate-x-1/2"></div>
    ...
    <nav class="relative z-10 container mx-auto px-6 py-6 flex justify-between items-center">
        <div class="flex items-center gap-2">
            <div class="w-10 h-10 bg-emerald-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg">T</div>
            <span class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-600">TabunganSiswa</span>
        </div>
        <div class="hidden md:flex gap-8 font-medium text-slate-600">
            <a href="#features" class="hover:text-emerald-600 transition">Fitur</a>
            <a href="#about" class="hover:text-emerald-600 transition">Tentang</a>
    ...
    <main class="relative z-10 container mx-auto px-6 pt-10 pb-20 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div class="flex-1 text-center lg:text-left">
            <div class="inline-block px-4 py-1.5 bg-white border border-emerald-100 rounded-full text-emerald-600 font-semibold text-sm mb-6 shadow-sm">
                👋 Selamat Datang di Platform Tabungan Sekolah
            </div>
            <h1 class="text-5xl lg:text-7xl font-bold leading-tight mb-6 text-slate-900">
                Kelola Tabungan <br>
                <span class="text-emerald-600">Lebih Mudah</span> & Aman
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href="/login" class="group relative px-8 py-4 bg-emerald-600 text-white font-semibold rounded-2xl shadow-emerald-200 shadow-xl hover:shadow-2xl hover:bg-emerald-700 transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden w-full sm:w-auto">
        ...
        <div class="flex-1 relative w-full max-w-lg lg:max-w-none">
            <div class="relative w-full aspect-square max-w-md mx-auto animate-float">
                <!-- Abstract Cards UI -->
                <div class="absolute inset-0 bg-gradient-to-tr from-emerald-500 to-teal-400 rounded-[3rem] rotate-6 opacity-20 blur-lg"></div>
                <div class="glass-card absolute inset-4 rounded-[2.5rem] p-8 flex flex-col justify-between">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                            ...
                            <span class="text-sm font-bold text-emerald-600">+ Rp 20.000</span>
                        </div>
    ...
    <section id="features" class="bg-white py-20">
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                <div class="p-8 rounded-3xl bg-slate-50 hover:bg-emerald-50 transition duration-300 border border-slate-100 hover:border-emerald-100">
